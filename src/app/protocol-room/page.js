  ...
  <div className="hero-inner">
    ...
    <div className="price-card">
      ...
      <div className="price-card-body">
        ...
        <a href="https://link.fastpaydirect.com/payment-link/69d2db38a6c96e61a845fd05" target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ background: "transparent", border: "1px solid var(--burg)", color: "var(--burg)" }}>Join The Protocol Room $28 (Subscription)</a>
    ...
    <div className="sessions-grid">
      ...
      <div className="session-card">
        <div className="session-card-header">
          ...
          <div style={{"fontSize":"10px","color":"var(--pmuted)","textAlign":"right","letterSpacing":"0.1em"}}>
            MON 14 APRIL<br/>2:00 AM London*<br/>9:00 PM NY*
          </div>
        </div>
      ...
      <div className="session-card">
        <div className="session-card-header">
          ...
          <div style={{"fontSize":"10px","color":"var(--pmuted)","textAlign":"right","letterSpacing":"0.1em"}}>
            TUE 15 APRIL<br/>2:00 AM London*<br/>9:00 PM NY*
          </div>
        </div>
        <div className="session-card-body">
...
<section className="final-cta">
  <div className="final-cta-inner">
    ...
    <div style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap", marginBottom: "16px" }}>
      ...
      <a href="https://link.fastpaydirect.com/payment-link/69d2db38a6c96e61a845fd05" target="_blank" rel="noopener noreferrer" className="btn-large" style={{ background: "transparent", border: "1px solid var(--burg)", color: "var(--burg)", marginBottom: 0 }}>Join The Protocol Room $28 (Subscription)</a>
    </div>
